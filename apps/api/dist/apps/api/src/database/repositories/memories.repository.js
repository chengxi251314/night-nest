...
let MemoriesRepository = class MemoriesRepository {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async findByUserAndCharacter(userId, characterId) {
        try {
            ...
            return seed_data_1.seedMemories.filter((item) => item.userId === userId && item.characterId === characterId);
        }
    }
};
exports.MemoriesRepository = MemoriesRepository;
exports.MemoriesRepository = MemoriesRepository = __decorate([
