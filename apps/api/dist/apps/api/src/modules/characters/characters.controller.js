...
let CharactersController = class CharactersController {
    ...
    findOne(id) { return this.charactersService.findOne(id); }
    create(body) { return this.charactersService.create(body); }
    update(id, body) { return this.charactersService.update(id, body); }
    remove(id) { return this.charactersService.remove(id); }
    ...
    async uploadBackground(id, req, res) {
        try {
            const multer = require("multer");
            ...
            const storage = multer.diskStorage({
                destination: function (_req, _file, cb) { cb(null, bgDir); },
...
], CharactersController.prototype, "uploadImage", null);
__decorate([
    (0, common_1.Post)(":id/background"),
    __param(0, (0, common_1.Param)("id")),
    ...
    __metadata("design:returntype", Promise)
], CharactersController.prototype, "uploadBackground", null);
exports.CharactersController = CharactersController = __decorate([
    (0, common_1.Controller)("v1/characters"),
