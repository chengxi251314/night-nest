    ...
    <html lang="zh-CN">
      <head>
        ...
        <style>{`
          ...
          @keyframes borderGlow{0%,100%{border-color:rgba(143,124,255,0.06)}50%{border-color:rgba(143,124,255,0.22)}}
          @keyframes gradientShift{0%{background-position:0% 50%}50%{background-position:100% 50%}100%{background-position:0% 50%}}
          *{box-sizing:border-box;margin:0;padding:0}
          html,body{min-height:100dvh;background:var(--bg);color:var(--text);font-family:-apple-system,BlinkMacSystemFont,"PingFang SC","SF Pro Display","Microsoft YaHei",sans-serif;-webkit-tap-highlight-color:transparent;-webkit-font-smoothing:antialiased;overflow-x:hidden}
          ...
          @media(max-width:768px){.hide-mobile{display:none!important}.show-mobile{display:flex!important}.stack-mobile{grid-template-columns:1fr!important}.grid-2-mobile{grid-template-columns:repeat(2,minmax(0,1fr))!important}h1{font-size:22px!important}h2{font-size:18px!important}}
        `}</style>
      </head>
      <body>
        <StarField />
